...
import { PALETTE_COLORS } from "./palette-library";
...
export const STAGE_KNOWLEDGE: ProgramKnowledge[] = [
  ...
  },
  {
    ...
    costumeStyles: [
      ...
      { name: "现代极简式", female: "纯色宽松套装,便于地面动作", male: "同色系宽松套装", accessories: ["无配饰或单色发带"], moods: ["现代舞", "先锋", "情绪"] },
...
export const UNIVERSAL_FORMATIONS: FormationTemplate[] = [
  ...
  { name: "扇形声部排列式", summary: "以指挥为圆心扇面展开,按乐器/声部分区", rows: 3, spacingRule: "弧线弦距 70cm,层间半径差 1.2m,声部间留 80cm 分界", countRange: [12, 50], tips: "器乐与民乐合奏标准队形;高音区靠外、低音区靠内,谱架与人错位摆放。", universal: true, tags: ["器乐", "乐团", "扇形", "声部"] },
  { name: "景深三区戏剧式", summary: "前中后三个表演分区,按场景切换调度", rows: 3, spacingRule: "前区距台口 1m,区间纵深各约 1/3 台深,横向自由", countRange: [6, 30], tips: "课本剧/戏剧通用;主角色居前区,群演中后区候场式站位,配合灯光分区切换场景。", universal: true, tags: ["戏剧", "课本剧", "分区", "叙事", "调度"] },
