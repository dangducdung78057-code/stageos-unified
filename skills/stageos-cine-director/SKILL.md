...
2. **定视觉叙事弧**：按 [references/color-script.md](references/color-script.md) 把节目切成 3–6 个叙事段落；每段先查 [references/cine-language.md](references/cine-language.md) 的规则引擎定情绪方向与布光模板，再回 color-script.md 选 hex 与色温。
...
- [references/shot-language.md](references/shot-language.md)：景别/角度/构图与 2.5D、3D 相机映射
- [references/color-script.md](references/color-script.md)：叙事弧模型 + 实测 hex 色系库 + 屏色脚本
- [references/cine-language.md](references/cine-language.md)：电影美学规则引擎（色彩情感词典、布光模板、服化道规则、构图队形、节目类型视觉规范库）
- [references/director-board.md](references/director-board.md)：分镜表 JSON schema
